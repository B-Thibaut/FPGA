...
-- Equation(s):
-- \FAD1|b2v_inst|HA2|S~combout\ = ( \SW[9]~input_o\ & ( !\SW[0]~input_o\ $ (\SW[4]~input_o\) ) ) # ( !\SW[9]~input_o\ & ( !\SW[0]~input_o\ $ (!\SW[4]~input_o\) ) )
...
-- Equation(s):
-- \FAD1|b2v_inst1|HA2|S~combout\ = ( \SW[9]~input_o\ & ( \SW[1]~input_o\ & ( !\SW[5]~input_o\ $ (((\SW[4]~input_o\) # (\SW[0]~input_o\))) ) ) ) # ( !\SW[9]~input_o\ & ( \SW[1]~input_o\ & ( !\SW[5]~input_o\ $ (((\SW[0]~input_o\ & \SW[4]~input_o\))) ) ) ) # ( 
-- \SW[9]~input_o\ & ( !\SW[1]~input_o\ & ( !\SW[5]~input_o\ $ (((!\SW[0]~input_o\ & !\SW[4]~input_o\))) ) ) ) # ( !\SW[9]~input_o\ & ( !\SW[1]~input_o\ & ( !\SW[5]~input_o\ $ (((!\SW[0]~input_o\) # (!\SW[4]~input_o\))) ) ) )
...
-- Equation(s):
-- \FAD1|b2v_inst1|Cout~combout\ = ( \SW[1]~input_o\ & ( \SW[9]~input_o\ & ( ((\SW[4]~input_o\) # (\SW[0]~input_o\)) # (\SW[5]~input_o\) ) ) ) # ( !\SW[1]~input_o\ & ( \SW[9]~input_o\ & ( (\SW[5]~input_o\ & ((\SW[4]~input_o\) # (\SW[0]~input_o\))) ) ) ) # ( 
-- \SW[1]~input_o\ & ( !\SW[9]~input_o\ & ( ((\SW[0]~input_o\ & \SW[4]~input_o\)) # (\SW[5]~input_o\) ) ) ) # ( !\SW[1]~input_o\ & ( !\SW[9]~input_o\ & ( (\SW[5]~input_o\ & (\SW[0]~input_o\ & \SW[4]~input_o\)) ) ) )
...
-- Location: LABCELL_X11_Y60_N51
\FAD1|b2v_inst2|HA2|S\ : cyclonev_lcell_comb
-- Equation(s):
-- \FAD1|b2v_inst2|HA2|S~combout\ = ( \SW[6]~input_o\ & ( \SW[2]~input_o\ & ( \FAD1|b2v_inst1|Cout~combout\ ) ) ) # ( !\SW[6]~input_o\ & ( \SW[2]~input_o\ & ( !\FAD1|b2v_inst1|Cout~combout\ ) ) ) # ( \SW[6]~input_o\ & ( !\SW[2]~input_o\ & ( 
-- !\FAD1|b2v_inst1|Cout~combout\ ) ) ) # ( !\SW[6]~input_o\ & ( !\SW[2]~input_o\ & ( \FAD1|b2v_inst1|Cout~combout\ ) ) )
...
-- Location: LABCELL_X11_Y60_N6
\FAD1|b2v_inst3|HA2|S\ : cyclonev_lcell_comb
-- Equation(s):
-- \FAD1|b2v_inst3|HA2|S~combout\ = ( \SW[3]~input_o\ & ( \SW[2]~input_o\ & ( !\SW[7]~input_o\ $ (((\FAD1|b2v_inst1|Cout~combout\) # (\SW[6]~input_o\))) ) ) ) # ( !\SW[3]~input_o\ & ( \SW[2]~input_o\ & ( !\SW[7]~input_o\ $ (((!\SW[6]~input_o\ & 
-- !\FAD1|b2v_inst1|Cout~combout\))) ) ) ) # ( \SW[3]~input_o\ & ( !\SW[2]~input_o\ & ( !\SW[7]~input_o\ $ (((\SW[6]~input_o\ & \FAD1|b2v_inst1|Cout~combout\))) ) ) ) # ( !\SW[3]~input_o\ & ( !\SW[2]~input_o\ & ( !\SW[7]~input_o\ $ (((!\SW[6]~input_o\) # 
-- (!\FAD1|b2v_inst1|Cout~combout\))) ) ) )
...
PORT MAP (
	...
	datab => \FAD1|b2v_inst1|ALT_INV_Cout~combout\,
...
-- Equation(s):
-- \FAD1|b2v_inst3|Cout~combout\ = ( \SW[7]~input_o\ & ( \SW[2]~input_o\ & ( ((\SW[3]~input_o\) # (\SW[6]~input_o\)) # (\FAD1|b2v_inst1|Cout~combout\) ) ) ) # ( !\SW[7]~input_o\ & ( \SW[2]~input_o\ & ( (\SW[3]~input_o\ & ((\SW[6]~input_o\) # 
-- (\FAD1|b2v_inst1|Cout~combout\))) ) ) ) # ( \SW[7]~input_o\ & ( !\SW[2]~input_o\ & ( ((\FAD1|b2v_inst1|Cout~combout\ & \SW[6]~input_o\)) # (\SW[3]~input_o\) ) ) ) # ( !\SW[7]~input_o\ & ( !\SW[2]~input_o\ & ( (\FAD1|b2v_inst1|Cout~combout\ & 
...
-- pragma translate_on
PORT MAP (
	dataa => \FAD1|b2v_inst1|ALT_INV_Cout~combout\,
